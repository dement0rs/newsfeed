...
class newsfeedTests: XCTestCase {
    ...
    func testCreateURLWithRightParameters() throws {
        ...
        let urlCreator = URLCreator(scheme: "https", host: "newsapi.org", apiKey: "e56c97e0c2344aa2817396a7f2deb097")
        
        let result = urlCreator.createURL(endpoint: Endpoints.everything, queryItems: everything)
        let enotherResult = URL(string: "https://newsapi.org/v2/everything?q=COVID-19&from=2021-02-07&to=2021-02-07&sortBy=popularity&apiKey=e56c97e0c2344aa2817396a7f2deb097")
        XCTAssertEqual(result, enotherResult
